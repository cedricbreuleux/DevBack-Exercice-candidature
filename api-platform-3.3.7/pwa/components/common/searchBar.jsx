    ...
    return (
        <div className="w-full lg:w-5/12 md:w-6/12 sm:w-8/12">   
            ...
            <div className="relative">
                ...
                <input value={searchValue} onChange={handleChange} type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Rechercher un livre par titre" />
